...
import correlation.ARFFMaker.Parms.APOParms;
...
public class APOMakeARFFfromSQL extends AttributeMakerFromSQL {
	...
	public static void main(String[] args) throws Exception {
		...
		String data = apo.makeARFFFromSQL(sym, daysOut, parms, whichGroup.END);
	...
	public static String getFilename(String sym, int dos) {
		return "c:/users/joe/correlationARFF/" + sym + "_" + dos + "_apo2bb_correlation.arff";
	}
	...
	public AttributeParm buildParameters(String sym, int daysOut, Connection conn) throws Exception {
		...
		while (rs.next()) {
			...
			parms.addSymbol(symKey, rs.getInt("functionDaysDiff"), rs.getInt("doubleBack"), gsdAPO.dateIndex, apo);
		}
		return parms;
	}
