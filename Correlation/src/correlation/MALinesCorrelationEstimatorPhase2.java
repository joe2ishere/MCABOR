...
public class MALinesCorrelationEstimatorPhase2 extends CorrelationEstimatorPhase2 {

	Core core = new Core();
	MALinesMakeARFFfromSQLPhase2 makeSQL = new MALinesMakeARFFfromSQLPhase2(false);

	public MALinesCorrelationEstimatorPhase2(Connection conn) throws SQLException {
		super(conn);
